const projects = (path, authorization, limit, page, search = null, type = null) => {
  return {
    ...
    data: {
      ...
      projects: [
        {
          project_name: `mock-project-id-${search !== null ? `search-${search}-` : ''}${type !== null ? `type-${type}-` : ''}${page * limit - (limit - 1)}`,
          ...
          ancestry: `fake.net > tfe > project-id-${page * limit - (limit - 1)} > non-production`,
          tfe_management_enabled: true,
        },
        {
          project_name: `mock-project-id-${search !== null ? `search-${search}-` : ''}${type !== null ? `type-${type}-` : ''}${page * limit - (limit - 2)}`,
        ...
        {
          project_name: `mock-project-id-${search !== null ? `search-${search}-` : ''}${type !== null ? `type-${type}-` : ''}${page * limit - (limit - 3)}`,
        ...
        {
          project_name: `mock-project-id-${search !== null ? `search-${search}-` : ''}${type !== null ? `type-${type}-` : ''}${page * limit - (limit - 4)}`,
          ...
          ancestry: `fake.net > tfe > project-id-${page * limit - (limit - 1)} > production`,
          tfe_management_enabled: false,
        },
        {
          project_name: `mock-project-id-${search !== null ? `search-${search}-` : ''}${type !== null ? `type-${type}-` : ''}${page * limit - (limit - 5)}`,
